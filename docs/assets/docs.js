(() => {
  ...
  Object.assign(translations['zh-CN'], {
    '文档中心 | LeavesAntiIllegal 3.1.1': 'Documentation | LeavesAntiIllegal 3.1.1',
    ...
    'LeavesAntiIllegal 3.1.1 · 文档中心': 'LeavesAntiIllegal 3.1.1 · Documentation', '最后更新：2026-08-15': 'Last updated: 2026-08-15',

    '服主手册 | LeavesAntiIllegal': 'Server Owner Guide | LeavesAntiIllegal', 'LeavesAntiIllegal 3.1.1 服主安装、配置、迁移与恢复手册': 'LeavesAntiIllegal 3.1.1 server installation, configuration, migration, and recovery guide',
    ...
    '配置版本 3': 'Config version 3', '插件版本 3.1.1': 'Plugin version 3.1.1', '共 12 个章节': '12 sections',
    '没有匹配的章节，请尝试材料名、配置键或命令。': 'No matching sections. Try a material name, configuration key, or command.',
    ...
    '开发者文档 | LeavesAntiIllegal 3.1.1': 'Developer Guide | LeavesAntiIllegal 3.1.1', '开发者文档 · 3.1.1': 'Developer Guide · 3.1.1', 'LeavesAntiIllegal 开发者文档': 'LeavesAntiIllegal Developer Guide',
  ...
  Object.assign(translations['zh-CN'], {
    ...
    '# 发布基线\nmvn clean package\n# => target/LeavesAntiIllegal-3.1.1.jar\n\n# 1.21.11 兼容编译\nmvn -Pleaves-1.21.11 clean package\n# => target/LeavesAntiIllegal-3.1.1.jar': '# Release baseline\nmvn clean package\n# => target/LeavesAntiIllegal-3.1.1.jar\n\n# 1.21.11 compatibility build\nmvn -Pleaves-1.21.11 clean package\n# => target/LeavesAntiIllegal-3.1.1.jar',
    'LeavesAntiIllegal 3.1.1 服主安装、配置、迁移与恢复手册': 'LeavesAntiIllegal 3.1.1 server installation, configuration, migration, and recovery guide',
    '配置、备份、命令…': 'Configuration, backups, commands...', '文档目录': 'Documentation contents', '物品扫描覆盖流程': 'Item scanning coverage flow',
    'LeavesAntiIllegal 3.1.1 架构、线程、构建与扩展文档': 'LeavesAntiIllegal 3.1.1 architecture, threading, build, and extension guide', '线程、NBT、构建…': 'Threading, NBT, builds...',
  ...
  Object.assign(translations['zh-CN'], {
    '文档中心 | LeavesAntiIllegal 3.1.1': 'Documentation | LeavesAntiIllegal 3.1.1',
    'LeavesAntiIllegal 3.1.1 · 文档中心': 'LeavesAntiIllegal 3.1.1 · Documentation',
    'LeavesAntiIllegal 3.1.1 服主安装、配置、迁移与恢复手册': 'LeavesAntiIllegal 3.1.1 server installation, configuration, migration, and recovery guide',
    '插件版本 3.1.1': 'Plugin version 3.1.1',
    '开发者文档 | LeavesAntiIllegal 3.1.1': 'Developer Guide | LeavesAntiIllegal 3.1.1',
    '开发者文档 · 3.1.1': 'Developer Guide · 3.1.1',
    'LeavesAntiIllegal 3.1.1 · 开发者文档': 'LeavesAntiIllegal 3.1.1 · Developer Guide',
    '# 发布基线\nmvn clean package\n# => plugin/target/LeavesAntiIllegal-3.1.1.jar\n\n# 兼容 1.20 - 26.2 的统一产物\nmvn clean package\n# => plugin/target/LeavesAntiIllegal-3.1.1.jar': '# Release baseline\nmvn clean package\n# => plugin/target/LeavesAntiIllegal-3.1.1.jar\n\n# Unified artifact for 1.20 - 26.2\nmvn clean package\n# => plugin/target/LeavesAntiIllegal-3.1.1.jar'
  });
